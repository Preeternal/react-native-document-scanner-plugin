...
type PageSource = 'scanner' | 'picker' | 'gallery';
...
export default function App() {
  ...
  const pickImagesFromDevice = async () => {
    await runAction('pickImages', async () => {
      try {
        ...
        if (pickedUris.length === 0) {
          setLastError('Picker returned no readable image URIs.');
          return;
        }

        setScanStatus('picked');
        setPageSource('picker');
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.actionsGrid}>
            ...
            />
            <ActionButton
              title="pickImagesFromDevice()"
              onPress={pickImagesFromDevice}
              disabled={isBusy}
            />
            <ActionButton
              title="scanDocument()"
